* DATE: Oct 17/01
* DATE: Dec 07, Modified for use on E4.20 Digital IC Design
*       Imperial College London,  Peter Y. K. Cheung
* 
* Temperature_parameters=Default
.MODEL N NMOS (LEVEL   = 49 hdif = 0.25e-6 acm = 3 
...
*
.MODEL P PMOS (LEVEL   = 49 hdif = 0.25e-6 acm =3 
+VERSION = 3.1            TNOM    = 27             TOX     = 4.2E-9
